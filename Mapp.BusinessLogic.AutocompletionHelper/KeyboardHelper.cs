...
namespace Mapp.BusinessLogic.AutocompletionHelper
{
    //public class KeyboardHelper : IDisposable
    //{
    //    bool Global = false;

    //    public delegate void LocalKeyEventHandler(Key key, bool Shift, bool Ctrl, bool Alt);
    ...
    //    //Start hook
    //    public KeyboardHelper(bool Global)
    //    {
    //        this.Global = Global;
    ...
    //                    if (keydownup == 0)
    //                    {
    //                        if (KeyDown != null) KeyDown((Key)W, GetShiftPressed(), GetCtrlPressed(), GetAltPressed());
    //                    }
    //                    if (keydownup == -1)
    //                    {
    //                        if (KeyUp != null) KeyUp((Key)W, GetShiftPressed(), GetCtrlPressed(), GetAltPressed());
    //                    }
    //                    //System.Diagnostics.Debug.WriteLine("Down: " + (Key)W);
    //                }
    //            }
    //            else
    //            {
    ...
    //                //{
    //                //    if (KeyDown != null) KeyDown((Key)vkCode, GetShiftPressed(), GetCtrlPressed(), GetAltPressed());
    //                //}
    //                //if (kEvent == KeyEvents.KeyUp || kEvent == KeyEvents.SKeyUp)
    //                //{
    //                //    if (KeyUp != null) KeyUp((Key)vkCode, GetShiftPressed(), GetCtrlPressed(), GetAltPressed());
    //                //}
    //            }
    //        }
    //        catch (Exception)
    ...
    //    static public extern short GetKeyState(Key nVirtKey);

    //    public static bool GetCapslock()
    //    {
    //        return Convert.ToBoolean(GetKeyState(Key.CapsLock)) & true;
    //    }
    //    public static bool GetNumlock()
    //    {
    //        return Convert.ToBoolean(GetKeyState(Key.NumLock)) & true;
    //    }
    //    public static bool GetScrollLock()
    //    {
    //        return Convert.ToBoolean(GetKeyState(Key.Scroll)) & true;
    //    }
    //    public static bool GetShiftPressed()
    //    {
    //        int state = GetKeyState(Key.LeftShift);
    //        if (state > 1 || state < -1) return true;
    //        return false;
    //    }
    //    public static bool GetCtrlPressed()
    //    {
    //        int state = GetKeyState(Key.LeftCtrl);
    //        if (state > 1 || state < -1) return true;
    //        return false;
    //    }
    //    public static bool GetAltPressed()
    //    {
    //        int state = GetKeyState(Key.LeftAlt);
    //        if (state > 1 || state < -1) return true;
    //        return false;
    //    }
    //}
